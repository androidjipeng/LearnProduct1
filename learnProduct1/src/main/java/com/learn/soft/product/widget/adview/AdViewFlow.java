 ...
 */
package com.learn.soft.product.widget.adview;
 ...
 */
public class AdViewFlow extends AdapterView<Adapter> {
    ...
    private AbsListView mLvParent;
    private ScrollView mScrollView;

    public void setmLvParent(AbsListView mLvParent) {
        this.mLvParent = mLvParent;
    }
    public void setScrollView(ScrollView mLvParent) {
        this.mScrollView = mLvParent;
    }

    private ViewPager mArea2;
    public void setmArea2(ViewPager area2) {
        this.mArea2 = area2;
    }

    private SlidingPaneLayout mArea3;
    public void setmArea3(SlidingPaneLayout area3) {
        this.mArea3 = area3;
    }
	...
	public AdViewFlow(Context context, int sideBuffer) {
		super(context);
		mSideBuffer = sideBuffer;
		init();
	}

	public AdViewFlow(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray styledAttrs = context.obtainStyledAttributes(attrs,
				R.styleable.ViewFlow);
		mSideBuffer = styledAttrs.getInt(R.styleable.ViewFlow_sidebuffer, 0);
		init();
	}
...
//		}
    ...
    private void setIsInterceptParent(boolean isShow){
        if (mLvParent!=null){
            mLvParent.requestDisallowInterceptTouchEvent(isShow);
        }
    }

    private void setIsInterceptParent2(boolean isShow){
        if (mArea2!=null){
            mArea2.requestDisallowInterceptTouchEvent(isShow);
        }
    }

    private void setIsInterceptParent3(boolean isShow){
        if (mArea3!=null){
            mArea3.requestDisallowInterceptTouchEvent(isShow);
        }
    }

    private void setIsInterceptParent4(boolean isShow){
        if (mScrollView!=null){
            mScrollView.requestDisallowInterceptTouchEvent(isShow);
        }
    }
