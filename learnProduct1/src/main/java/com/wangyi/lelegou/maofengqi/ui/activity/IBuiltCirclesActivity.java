 ...
 * 
 */
public class IBuiltCirclesActivity extends BaseActivity implements
...
//	private CircleAdapter adapter;
	private CircleSelfAdapter adapter;
	...
	protected int getLayoutId() {
		return R.layout.activity_ibuilt_circles;
	}

	@Override
	protected void afterCreate(Bundle savedInstanceState) {
		tvContent.setText("我建的圈子");
	...
	private void setAdapter() {
		if (adapter == null) {
			adapter = new CircleSelfAdapter(mActivity, list,
	...
	public static void start(Context context) {
		Intent intent = new Intent(context, IBuiltCirclesActivity.class);
